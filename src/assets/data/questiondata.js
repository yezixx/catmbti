export const QuestionData = [
  {
    ...
    answera: "머해? 이름은 뭐로 지어줄까? 자꾸 말을 걸고 싶다.",
  ...
  },
  {
    ...
    answera:
      "'겨울이 너무 이쁜 것 같아.. 사람들한테 자랑해야지..!!'하며 인스타를 만들어서 사진도 공유하고 소통도 한다.",
  ...
  },
  {
    ...
    answera:
      "'우리 고양이 몸무게는 5키로니까 하루세번 몇시에 이만큼 씩 주고, 간식은 이때 챙겨줘야겠다. 영양제도 미리",
  ...
  },
  {
    ...
    answera:
      "사료를 조금씩 급여해서 고양이의 기호를 테스트 해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며",
